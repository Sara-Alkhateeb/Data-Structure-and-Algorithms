...
def sort_by_most_recent(array):
    """
    Sorts the movies in the array by the year in descending order.

    Args:
        array (list): A list of movie dictionaries.

    Returns:
        list: A new list of movie dictionaries sorted by the year in descending order.
    """
...
def sort_alphabetical(array):
    """
    Sorts the movies in the array by the title in alphabetical order, ignoring leading articles (e.g., "A", "An", "The").

    Args:
        array (list): A list of movie dictionaries.

    Returns:
        list: A new list of movie dictionaries sorted by the title in alphabetical order.
    """
